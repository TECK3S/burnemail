#############################################################################
# Makefile for building: bmailz
# Generated by qmake (2.01a) (Qt 4.6.2) on: Sun Jun 26 20:13:51 2011
# Project:  burnemail.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -unix -o Makefile burnemail.pro
#############################################################################
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		TCPSocket.cpp moc_mainwindow.cpp \
		moc_TCPSocket.cpp
OBJECTS       = main.o \
		mainwindow.o \
		TCPSocket.o \
...
Makefile: burnemail.pro  /usr/lib/qt4/mkspecs/linux-g++/qmake.conf /usr/lib/qt4/mkspecs/common/g++-multilib.conf \
		/usr/lib/qt4/mkspecs/common/unix.conf \
		/usr/lib/qt4/mkspecs/common/linux.conf \
		/usr/lib/qt4/mkspecs/qconfig.pri \
		/usr/lib/qt4/mkspecs/features/qt_functions.prf \
		...
		/usr/lib/qt4/mkspecs/features/lex.prf \
		/usr/lib/qt4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -unix -o Makefile burnemail.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/bmailz1.0.0 || $(MKDIR) .tmp/bmailz1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/bmailz1.0.0/ && $(COPY_FILE) --parents mainwindow.hh TCPSocket.hh .tmp/bmailz1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp TCPSocket.cpp .tmp/bmailz1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/bmailz1.0.0/ && (cd `dirname .tmp/bmailz1.0.0` && $(TAR) bmailz1.0.0.tar bmailz1.0.0 && $(COMPRESS) bmailz1.0.0.tar) && $(MOVE) `dirname .tmp/bmailz1.0.0`/bmailz1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/bmailz1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_TCPSocket.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_TCPSocket.cpp
moc_mainwindow.cpp: TCPSocket.hh \
		mainwindow.hh
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) mainwindow.hh -o moc_mainwindow.cpp

moc_TCPSocket.cpp: TCPSocket.hh
...
mainwindow.o: mainwindow.cpp TCPSocket.hh \
		mainwindow.hh \
		ui_mainwindow.h
